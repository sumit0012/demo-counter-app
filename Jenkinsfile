            ...
            stage('upload jar file to nexus'){
                ...
                steps{
                    ...
                    script{
                        ...
                        def nexusRepo = readPomVersion.version.endsWith("SNAPSHOT") ? "app-snapshot" : "app-repo"
                ...
                steps{
                    script{
                        withCredentials([string(credentialsId: 'docker-pass', variable: 'docker-cred')]) {
                            ...
                            sh 'docker login --username sam3ctc --password-stdin ${docker-cred}'
